...
def perform_cohort_analysis(
    ...
    # Ensure all unique columns are actually in the reasons_df before selecting
    final_unique_cols = [col for col in unique_cols if col in reasons_df.columns]
    reasons_df = reasons_df[final_unique_cols]
